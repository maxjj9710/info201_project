...
## Household Income 
Next, we wanted to see if there was a correlation between the air quality and the majority race and income for the county. To begin that analysis, we charted the annual household income by race. 
```{r, echo = F, message=FALSE}
